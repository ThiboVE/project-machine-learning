...
\begin{abstract}
  ...
  \textcolor{purple}{Rewrite abstract to only contain 5 sentences:}
  \textbf{Context:}
  \textbf{Problem:}
  \textbf{Solution:}
  \textbf{Results:}
