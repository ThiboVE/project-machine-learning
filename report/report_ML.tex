...
Continuing with the perturbed latent space vectors, it is interesting to visualize some chemical structures to assess how well the cVAE can construct molecules with the same HOMO-LUMO gap and slightly different chemical structures. From assessing molecules 1, 5 and 10 from \cref{tab:cvae_samples}, ... \textcolor{blue}{dont add too much as the section is already long enough, save the insights for the discussion section}
...
\textcolor{blue}{Results of cVAE related to literature and why we get the observed results}
